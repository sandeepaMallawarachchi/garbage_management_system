              ...
              <Table.Cell className="whitespace-nowrap text-gray-900 dark:text-white">
                {schedule.date === null ? (
                  <input
                    ...
                    className="border border-gray-300 rounded py-1 px-2 text-gray-700 placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 ease-in-out w-28" 
